...
)
{
    ...
    while (td.keepParticle && !td.switchProcessor && stepFraction() < 1)
    {
        ...
        const label cell1 = cell();	//Comment
        ...
        +
          ...
          /
            (sqr(epsilon_) + 2*epsilon_*cosTheta + 2*sqr(cosTheta))
                    ...
                    const point insertP(position() - pDir*0.1*delaM);  //pos0 
